node {
    ...
    sh "/cicd/maven/bin/mvn sonar:sonar"
	...
	sh '/cicd/oc-tool/oc import-image cecl-poc-fileupload --from=docker.io/primaticsfinancial2017/cecl-poc-fileupload --confirm'
